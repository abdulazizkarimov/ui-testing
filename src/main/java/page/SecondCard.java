...
public class SecondCard extends Form {
    private ILink uploadLink = getElementFactory().getLink(By.xpath("//a[contains(@class, 'avatar-and-interests__upload-button')]"), "Upload Link");
    private IButton nextBtn = getElementFactory().getButton(By.xpath("//button[contains(@class, 'button--stroked')]"), "Next Button");
